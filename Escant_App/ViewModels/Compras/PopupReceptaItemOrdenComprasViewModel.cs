...
{
    public class PopupReceptaItemOrdenComprasViewModel : ViewModelBase
    {
        ...
        public PopupReceptaItemOrdenComprasViewModel()
        {
            AddTipoDescuento();
            AddUbicacion();

        }
        public PopupReceptaItemOrdenComprasViewModel(IServicioAdministracion_Catalogo catalogoServicio)
        {
        ...
        private async Task Ok_CommandAsync()
        {
            if (validaRecepcion())
            {
                MessagingCenter.Send<OrdenDetalleCompra>(OrdenDetalleCompraSeleccionado, "OnDataSourcePopupReceptaItemOrdenComprasChanged");
