...
{
    public class PopupActualizaDetalleInventarioViewModel: ViewModelBase
    {
        ...
        private bool _isVisibleInventarioInicial;
        private bool _isVisibleInventarioConciliaTransferencia;
        ...
        public bool IsVisibleInventarioInicial
        {
            get => _isVisibleInventarioInicial;
            set
            {
                _isVisibleInventarioInicial = value;
                RaisePropertyChanged(() => IsVisibleInventarioInicial);
            }
        }
        public bool IsVisibleInventarioConciliaTransferencia
        {
            get => _isVisibleInventarioConciliaTransferencia;
            set
            {
                _isVisibleInventarioConciliaTransferencia = value;
                RaisePropertyChanged(() => IsVisibleInventarioConciliaTransferencia);
            }
        }
        ...
        public PopupActualizaDetalleInventarioViewModel(IServicioSeguridad_Usuario seguridadServicio
        ...
        public async Task inicia()
        {
            ...
            IsVisibleInventarioConciliaTransferencia = OrdenDetalleCompraSeleccionado.TipoInventario.ToUpper().Contains("NICIA") ? false : true;
            IsVisibleInventarioInicial = OrdenDetalleCompraSeleccionado.TipoInventario.ToUpper().Contains("NICIA") ? true : false;
            IsVisibleCondicionesPeriodoPago = string.IsNullOrEmpty(OrdenDetalleCompraSeleccionado.IdPeriodoServicio) ? false : true;
            ImpuestoLabel = "Impuesto";
        ...
        {
            if (!OrdenDetalleCompraSeleccionado.TipoInventario.ToUpper().Contains("NICIA"))
            {
        ...
        {
            if(OrdenDetalleCompraSeleccionado!=null)
            { 
            var precio = OrdenDetalleCompraSeleccionado.TipoInventario.ToUpper().Contains("NICIA")?OrdenDetalleCompraSeleccionado.ValorUnitario:(PrecioSeleccionado!=null?PrecioSeleccionado.PrecioVenta: OrdenDetalleCompraSeleccionado.ValorUnitario);
            ...
            {
                case 1:
                    if (Cantidad > ExistenteFecha && !OrdenDetalleCompraSeleccionado.TipoInventario.ToUpper().Contains("NICIA"))
                    {
                    ...
                    OrdenDetalleCompraSeleccionado.ValorConversion = !OrdenDetalleCompraSeleccionado.TipoInventario.ToUpper().Contains("NICIA")?PrecioSeleccionado.ValorConversion: OrdenDetalleCompraSeleccionado.ValorConversion;
